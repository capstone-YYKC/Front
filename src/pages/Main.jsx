 ...
 // const ccontents = ['난 정말 슬퍼..', '난 정말 오늘도 슬퍼..'] 
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const prompt = `일기 내용: ${SUM}\n너는 '곰곰이'라는 이름의 일기 인형이야. 너의 역할은 사용자의 일기를 친구처럼 다정하게 들어주고, 심리적으로 도움이 되는 분석을 제공하는 거야.(패턴, 감정비율 같은) 사용자의 일기 내용을 바탕으로 300자 내외로 반말로 작성해줘. 사용자가 위로받고 용기를 얻을 수 있도록 다정하고 친근한 어투로 말해줘. 가끔 이모지도 한두 개 넣어서 말투가 더 따뜻하게 느껴지게 해줘. '/'로 일기 별로 나눠놨어.`;
