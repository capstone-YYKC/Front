...
const Main = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const prompt = `일기 내용: ${allContents}\n너는 일기를 녹음하는 일기 인형 곰곰이야. 다정한 친구처럼 전체 일기들에 대한 코멘트를 심리학적으로 도움이 되게 생성해줘. 코멘트의 내용은 각 감정의 발생 비율(%)과 감정 패턴에 대한 설명을 500자 정도로 제공해줘. 예전 일기는 무시하고 내가 준 일기만 분석해. 일기 내용이 없으면 분석하지 말고 없다고 말해. `;
